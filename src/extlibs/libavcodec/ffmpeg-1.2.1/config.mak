...
CC_IDENT=gcc 4.1.2 (GCC)
ARCH=mips
CC=/opt/mipsel-4.1.2-nopic/bin//mipsel-linux-gcc
CXX=/opt/mipsel-4.1.2-nopic/bin//mipsel-linux-g++
AS=/opt/mipsel-4.1.2-nopic/bin//mipsel-linux-gcc
LD=/opt/mipsel-4.1.2-nopic/bin//mipsel-linux-gcc
DEPCC=/opt/mipsel-4.1.2-nopic/bin//mipsel-linux-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/opt/mipsel-4.1.2-nopic/bin//mipsel-linux-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=/opt/mipsel-4.1.2-nopic/bin//mipsel-linux-ar
ARFLAGS=rc
AR_O=$@
RANLIB=/opt/mipsel-4.1.2-nopic/bin//mipsel-linux-ranlib
CP=cp -p
LN_S=ln -s -f
STRIP=/opt/mipsel-4.1.2-nopic/bin//mipsel-linux-strip
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600
CFLAGS=-mips32 -O3 -mno-abicalls -fno-pic -fno-builtin -fno-exceptions -ffunction-sections -mlong-calls -fomit-frame-pointer -msoft-float -G 4 -Wmissing-include-dirs -I/data/Developpement/nds-ds2/ds2sdk/libsrc/fs/ -I/data/Developpement/nds-ds2/ds2sdk/include -I/data/Developpement/nds-ds2/ds2sdk/libsrc/zlib -include stdio.h -include ds2_malloc.h   -std=c99 -fomit-frame-pointer -mips32r2 -pthread -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Os -fno-math-errno -fno-tree-vectorize
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=-L/data/Developpement/nds-ds2/ds2sdk/lib  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
