...
------------------------------------------------------------------------------*/
  ...
  extern void BDF_render_string (void *screen_address, unsigned int x,
				 unsigned int y, unsigned int back,
				 unsigned int front, char *string);
  extern unsigned int BDF_render16_ucs (void *screen_address,
					unsigned int screen_w,
					unsigned int v_align,
					unsigned int back, unsigned int front,
					unsigned short ch);
  extern void BDF_render_mix (void *screen_address, unsigned int screen_w,
			      unsigned int x, unsigned int y,
			      unsigned int v_align, unsigned int back,
			      unsigned int front, char *string);
//extern unsigned int BDF_string_width(char *string, unsigned int *len);
  extern char *utf8decode (char *utf8, unsigned short *ucs);
  extern unsigned char *skip_utf8_unit (unsigned char *utf8,
					unsigned int num);
  extern unsigned int BDF_cut_unicode (unsigned short *unicodes,
				       unsigned int len, unsigned int width,
				       unsigned int direction);
  extern unsigned int BDF_cut_string (char *string, unsigned int width,
				      unsigned int direction);
