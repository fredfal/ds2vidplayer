...
#define ICON_PLAY_SEL			gui_icon_list[3]
#define ICON_PLAY_NSEL			gui_icon_list[4]
#define ICON_PAUSE_SEL			gui_icon_list[5]
#define ICON_PAUSE_NSEL			gui_icon_list[6]
#define ICON_STOP_SEL			gui_icon_list[7]
#define ICON_STOP_NSEL			gui_icon_list[8]
#define ICON_START_SEL			gui_icon_list[9]
#define ICON_START_NSEL			gui_icon_list[10]
#define ICON_RR_SEL			gui_icon_list[11]
#define ICON_RR_NSEL			gui_icon_list[12]
#define ICON_FF_SEL			gui_icon_list[13]
#define ICON_FF_NSEL			gui_icon_list[14]
#define ICON_DOWN_BUTTON_SEL		gui_icon_list[15]
#define ICON_DOWN_BUTTON_NSEL		gui_icon_list[16]


#define ICON_UNKNOW			gui_icon_list[17]
#define ICON_MAINBG			gui_icon_list[18]

#define ICON_TITLEICON			gui_icon_list[19]
#define ICON_SUBBG			gui_icon_list[20]

#define ICON_SUBSELA			gui_icon_list[21]
#define ICON_DOTDIR			gui_icon_list[22]
#define ICON_BACK			gui_icon_list[23]
#define ICON_NBACK			gui_icon_list[24]
#define ICON_MSG			gui_icon_list[25]
#define ICON_BUTTON			gui_icon_list[26]
#define ICON_PROGRESS			gui_icon_list[27]
#define ICON_NPROGRESS			gui_icon_list[28]

/******************************************************************************
 *
 ******************************************************************************/
  extern void print_string_center (void *screen_addr, u32 sy, u32 color,
				   u32 bg_color, char *str);
  extern void print_string_shadow_center (void *screen_addr, u32 sy,
					  u32 color, char *str);
  ...
  extern void drawbox (void *screen_address, u32 sx, u32 sy, u32 ex, u32 ey,
		       u32 color);
  extern void drawboxfill (void *screen_address, u32 sx, u32 sy, u32 ex,
			   u32 ey, u32 color);
  extern void draw_selitem (void *screen_address, u32 x, u32 y, u32 color,
			    u32 active);
  extern void draw_message (void *screen_address, u16 * screen_bg, u32 sx,
			    u32 sy, u32 ex, u32 ey, u32 color_fg);
  extern void draw_string_vcenter (void *screen_address, u32 sx, u32 sy,
				   u32 width, u32 color_fg, char *string);

#define MAX_SCROLL_STRING   16
  extern u32 draw_hscroll_init (void *screen_address, u32 sx, u32 sy,
				u32 width, u32 color_bg, u32 color_fg,
				char *string);
  extern u32 draw_hscroll (u32 index, s32 scroll_val);
  extern void draw_hscroll_over (u32 index);
  extern void boxfill_alpha (u32 sx, u32 sy, u32 ex, u32 ey, u32 color,
			     u32 alpha);
  ...
  extern void scrollbar (void *screen_addr, u32 sx, u32 sy, u32 ex, u32 ey,
			 u32 all, u32 view, u32 now);
  extern u32 yesno_dialog (char *text);
  extern u32 draw_yesno_dialog (enum SCREEN_ID screen, u32 sy, char *yes,
				char *no);
  extern u32 draw_hotkey_dialog (enum SCREEN_ID screen, u32 sy, char *clear,
				 char *cancel);
  ...
  extern void show_icon (void *screen, struct gui_iconlist *icon, u32 x,
			 u32 y);
  extern void show_Vscrollbar (char *screen, u32 x, u32 y, u32 part,
			       u32 total);
  ...
  extern void blit_to_screen (void *screen_addr, u16 * src, u32 w, u32 h,
